...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: LINKUSD's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'LINKUSD', 'Evo', 'Generating', 'Mining', 'Network', 'Rawtransactions', 'Util']
