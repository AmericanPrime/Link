...
class PSBTTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 LUSD
        ...
        # feeRate of 0.1 LUSD / KB produces a total fee slightly below -maxtxfee (~0.06650000):
        ...
        # feeRate of 10 LUSD / KB produces a total fee well above -maxtxfee
