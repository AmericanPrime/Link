Contributing to LINKUSD Core
============================

The LINKUSD Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/AmericanPrime/LinkUSD.git/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list.
...
[Translation Process](https://github.com/AmericanPrime/LinkUSD.git/blob/master/doc/translation_process.md)
...
The following applies to code changes to the LINKUSD Core project (and related
projects such as libsecp256k1), and is not to be confused with overall LINKUSD
Network Protocol consensus changes.

Whether a pull request is merged into LINKUSD Core rests with the project merge
...
Patches that change LINKUSD consensus rules are considerably more involved than
...
Where a patch set proposes to change the LINKUSD consensus, it must have been
...
The review process is normally fairly responsive on the LINKUSD Core repository, however
...
Bitcoin Backports are an incredibly valuable part of LINKUSD's development. Backporting allows us to easily implement new
features, improvements and fixes as bitcoin implements them.

To see detailed statistics & progress see Google Sheet tracker: [Bitcoin backports for LINKUSD](https://docs.google.com/spreadsheets/d/1DnKxat0S0H62CJOzXpKGPXTa8hgoVOjGYZzoClmGSB8/edit?usp=sharing).
...
The project leader is the release manager for each LINKUSD Core release.
