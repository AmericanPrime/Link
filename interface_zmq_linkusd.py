...
"""Test the linkusd specific ZMQ notification interfaces."""
...
from test_framework.test_framework import LINKUSDTestFramework
...
class LINKUSDZMQTest (LINKUSDTestFramework):
    def set_test_params(self):
        ...
        self.set_linkusd_test_params(5, 4, fast_dip3_enforcement=True, extra_args=extra_args)
        self.set_linkusd_llmq_test_params(4, 4)
    ...
    def run_test(self):
        self.subscribers = {}
        # Check that linkusdd has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all linkusd related ZMQ publisher
