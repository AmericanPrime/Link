 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1725035723, nBits=1e0ffff0, nNonce=306058, vtx=1)
...
{
    const char* pszTimestamp = "The day of realization August 30 2024";
    const CScript genesisOutputScript = CScript() << ParseHex("04fd90b090c264522599b470fee7c836bed0deed62adb87d51d7694664951f50e19b1d6abb2a9fcc4d3185633397688573e8324b0ea52476793090b97c19162aa8") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.MinBIP9WarningHeight = 1 + 1; // V19 activation height + miner confirmation window
        ...
        consensus.defaultAssumeValid = uint256S("0x00000cd73ed5cba8d623bd52320b7bda93bb92599d8e26db667d23f76b98f2c5"); 
        ...
        genesis = CreateGenesisBlock(1725035723, 306058, 0x1e0ffff0, 1, 250 * COIN);
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x00000cd73ed5cba8d623bd52320b7bda93bb92599d8e26db667d23f76b98f2c5"));
        assert(genesis.hashMerkleRoot == uint256S("0x5413f4a46e53be1816c434cbd4521239379f9c4010e879c5a9de1764edd3a172"));
        ...
        vSeeds.emplace_back("192.168.70.185");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,48);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,49);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,176);
        // LINKUSD BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // LINKUSD BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // LINKUSD BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"Ld5A2HNmCfGm5UavKFVCBG1Q7KPYmWq1bi"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x00000cd73ed5cba8d623bd52320b7bda93bb92599d8e26db667d23f76b98f2c5")},
            }
        };
        ...
        // getchaintxstats 17280 00000cd73ed5cba8d623bd52320b7bda93bb92599d8e26db667d23f76b98f2c5
        chainTxData = ChainTxData{
                1725035723, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        consensus.nSuperblockMaturityWindow = 1;
        ...
        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x0000095b594d7a3218dc80fd86fc72de1cc1768f788774f56062ca99e7d2ff9b"); 
        ...
        genesis = CreateGenesisBlock(1725035728UL, 245457UL, 0x1e0ffff0, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000095b594d7a3218dc80fd86fc72de1cc1768f788774f56062ca99e7d2ff9b"));
        assert(genesis.hashMerkleRoot == uint256S("0x5413f4a46e53be1816c434cbd4521239379f9c4010e879c5a9de1764edd3a172"));
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,176);
        // Testnet LINKUSD BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet LINKUSD BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet LINKUSD BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"LZ6kiJ1XXbRPYaJR4PKh6MQRdHcpUwZFNo"};
        nMinSporkKeys = 1;

        checkpointData = {
            {
                {0, uint256S("0x0000095b594d7a3218dc80fd86fc72de1cc1768f788774f56062ca99e7d2ff9b")},
            }
        };
        ...
        // getchaintxstats 17280 0000095b594d7a3218dc80fd86fc72de1cc1768f788774f56062ca99e7d2ff9b
        chainTxData = ChainTxData{
                1725035728, // * UNIX timestamp of last known number of transactions
                0,    // * total number of transactions between genesis and that timestamp
                            //   (the tx=... number in the ChainStateFlushed debug.log lines)
                0,       // * estimated number of transactions per second after that timestamp
        };
...
public:
    explicit CDevNetParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1725035733, 4, 0x207fffff, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x1b172e61964d91c95fc8318279a9d2839d00891e1ab144c00c61d3e7549222ae"));
        assert(genesis.hashMerkleRoot == uint256S("0x5413f4a46e53be1816c434cbd4521239379f9c4010e879c5a9de1764edd3a172"));

        devnetGenesis = FindDevNetGenesisBlock(genesis, 250 * COIN);
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x1b172e61964d91c95fc8318279a9d2839d00891e1ab144c00c61d3e7549222ae")},
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        // privKey: 6uVuxJCKx9KnxK3uQASkiQXhKnPqEscWXwdeNhchpqUXmD95Hco
        vSporkAddresses = {"LMrbPsDBnuJD8WqeqbtEYhHRBYnywQRhHp"};
        nMinSporkKeys = 1;
        ...
        // Regtest LINKUSD addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,48);
        // Regtest LINKUSD script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,49);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,176);
        // Regtest LINKUSD BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest LINKUSD BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest LINKUSD BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
