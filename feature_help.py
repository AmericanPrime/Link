...
"""Verify that starting linkusdd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start linkusdd with -h for help text")
        ...
        self.log.info("Start linkusdd with -version for version information")
        ...
        self.log.info("Start linkusddd with -fakearg to make sure it does not start")
