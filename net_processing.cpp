 ...
 *  We have 4 times smaller block times in LINKUSD, so we need to push 4 times more invs per 1MB. */
...
bool PeerManagerImpl::AlreadyHave(const CInv& inv)
{
    ...
    /*
        LINKUSD Related Inventory Messages
...
bool PeerManagerImpl::SendMessages(CNode* pto)
{
...

    {
        ...
        // LUSD this code also handles non-TXs (LINKUSD specific messages)
